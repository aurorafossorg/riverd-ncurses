...
version(D_BetterC)
{
	void* dylib_load_ncurses() {
		...
		dylib_bindSymbol(handle, cast(void**)&addch, "addch");
		...
		dylib_bindSymbol(handle, cast(void**)&attroff, "attroff");
		dylib_bindSymbol(handle, cast(void**)&attron, "attron");
		dylib_bindSymbol(handle, cast(void**)&attrset, "attrset");
		...
		dylib_bindSymbol(handle, cast(void**)&bkgd, "bkgd");
		dylib_bindSymbol(handle, cast(void**)&bkgdset, "bkgdset");
		dylib_bindSymbol(handle, cast(void**)&border, "border");
		dylib_bindSymbol(handle, cast(void**)&box, "box");
		dylib_bindSymbol(handle, cast(void**)&can_change_color, "can_change_color");
		dylib_bindSymbol(handle, cast(void**)&cbreak, "cbreak");
		dylib_bindSymbol(handle, cast(void**)&chgat, "chgat");
		dylib_bindSymbol(handle, cast(void**)&nclear, "clear");
		dylib_bindSymbol(handle, cast(void**)&clearok, "clearok");
		dylib_bindSymbol(handle, cast(void**)&clrtobot, "clrtobot");
		dylib_bindSymbol(handle, cast(void**)&clrtoeol, "clrtoeol");
		dylib_bindSymbol(handle, cast(void**)&color_content, "color_content");
		dylib_bindSymbol(handle, cast(void**)&color_set, "color_set");
		...
		dylib_bindSymbol(handle, cast(void**)&getch, "getch");
		dylib_bindSymbol(handle, cast(void**)&getnstr, "getnstr");
		dylib_bindSymbol(handle, cast(void**)&getstr, "getstr");
		...
		dylib_bindSymbol(handle, cast(void**)&hline, "hline");
		...
		dylib_bindSymbol(handle, cast(void**)&inch, "inch");
		dylib_bindSymbol(handle, cast(void**)&inchnstr, "inchnstr");
		dylib_bindSymbol(handle, cast(void**)&inchstr, "inchstr");
		dylib_bindSymbol(handle, cast(void**)&init_color, "init_color");
		dylib_bindSymbol(handle, cast(void**)&init_pair, "init_pair");
		dylib_bindSymbol(handle, cast(void**)&innstr, "innstr");
		dylib_bindSymbol(handle, cast(void**)&insch, "insch");
		dylib_bindSymbol(handle, cast(void**)&insdelln, "insdelln");
		dylib_bindSymbol(handle, cast(void**)&insertln, "insertln");
		dylib_bindSymbol(handle, cast(void**)&insnstr, "insnstr");
		dylib_bindSymbol(handle, cast(void**)&insstr, "insstr");
		dylib_bindSymbol(handle, cast(void**)&instr, "instr");
		dylib_bindSymbol(handle, cast(void**)&intrflush, "intrflush");
		dylib_bindSymbol(handle, cast(void**)&isendwin, "isendwin");
		dylib_bindSymbol(handle, cast(void**)&is_linetouched, "is_linetouched");
		...
		dylib_bindSymbol(handle, cast(void**)&move, "move");
		dylib_bindSymbol(handle, cast(void**)&mvaddch, "mvaddch");
		dylib_bindSymbol(handle, cast(void**)&mvaddchnstr, "mvaddchnstr");
		dylib_bindSymbol(handle, cast(void**)&mvaddchstr, "mvaddchstr");
		dylib_bindSymbol(handle, cast(void**)&mvaddnstr, "mvaddnstr");
		dylib_bindSymbol(handle, cast(void**)&mvaddstr, "mvaddstr");
		dylib_bindSymbol(handle, cast(void**)&mvchgat, "mvchgat");
		dylib_bindSymbol(handle, cast(void**)&mvcur, "mvcur");
		dylib_bindSymbol(handle, cast(void**)&mvdelch, "mvdelch");
		dylib_bindSymbol(handle, cast(void**)&mvderwin, "mvderwin");
		dylib_bindSymbol(handle, cast(void**)&mvgetch, "mvgetch");
		dylib_bindSymbol(handle, cast(void**)&mvgetnstr, "mvgetnstr");
		dylib_bindSymbol(handle, cast(void**)&mvgetstr, "mvgetstr");
		dylib_bindSymbol(handle, cast(void**)&mvhline, "mvhline");
		dylib_bindSymbol(handle, cast(void**)&mvinch, "mvinch");
		dylib_bindSymbol(handle, cast(void**)&mvinchnstr, "mvinchnstr");
		dylib_bindSymbol(handle, cast(void**)&mvinchstr, "mvinchstr");
		dylib_bindSymbol(handle, cast(void**)&mvinnstr, "mvinnstr");
		dylib_bindSymbol(handle, cast(void**)&mvinsch, "mvinsch");
		dylib_bindSymbol(handle, cast(void**)&mvinsnstr, "mvinsnstr");
		dylib_bindSymbol(handle, cast(void**)&mvinsstr, "mvinsstr");
		dylib_bindSymbol(handle, cast(void**)&mvinstr, "mvinstr");
		dylib_bindSymbol(handle, cast(void**)&mvprintw, "mvprintw");
		dylib_bindSymbol(handle, cast(void**)&mvscanw, "mvscanw");
		dylib_bindSymbol(handle, cast(void**)&mvvline, "mvvline");
		...
		dylib_bindSymbol(handle, cast(void**)&mvwinch, "mvwinch");
		dylib_bindSymbol(handle, cast(void**)&mvwinchnstr, "mvwinchnstr");
		dylib_bindSymbol(handle, cast(void**)&mvwinchstr, "mvwinchstr");
		dylib_bindSymbol(handle, cast(void**)&mvwinnstr, "mvwinnstr");
		dylib_bindSymbol(handle, cast(void**)&mvwinsch, "mvwinsch");
		dylib_bindSymbol(handle, cast(void**)&mvwinsnstr, "mvwinsnstr");
		dylib_bindSymbol(handle, cast(void**)&mvwinsstr, "mvwinsstr");
		dylib_bindSymbol(handle, cast(void**)&mvwinstr, "mvwinstr");
		...
		dylib_bindSymbol(handle, cast(void**)&refresh, "refresh");
		...
		dylib_bindSymbol(handle, cast(void**)&scrl, "scrl");
		dylib_bindSymbol(handle, cast(void**)&scroll, "scroll");
		...
		dylib_bindSymbol(handle, cast(void**)&slk_attr_off, "slk_attr_off");
		dylib_bindSymbol(handle, cast(void**)&slk_attron, "slk_attron");
		dylib_bindSymbol(handle, cast(void**)&slk_attr_on, "slk_attr_on");
		...
		dylib_bindSymbol(handle, cast(void**)&standout, "standout");
		dylib_bindSymbol(handle, cast(void**)&standend, "standend");
		...
		dylib_bindSymbol(handle, cast(void**)&timeout, "timeout");
		dylib_bindSymbol(handle, cast(void**)&touchline, "touchline");
		dylib_bindSymbol(handle, cast(void**)&touchwin, "touchwin");
		dylib_bindSymbol(handle, cast(void**)&typeahead, "typeahead");
		dylib_bindSymbol(handle, cast(void**)&ungetch, "ungetch");
		dylib_bindSymbol(handle, cast(void**)&untouchwin, "untouchwin");
		...
		dylib_bindSymbol(handle, cast(void**)&vline, "vline");
		...
		dylib_bindSymbol(handle, cast(void**)&wattron, "wattron");
		dylib_bindSymbol(handle, cast(void**)&wattroff, "wattroff");
		...
		dylib_bindSymbol(handle, cast(void**)&wdeleteln, "wdeleteln");
		...
		dylib_bindSymbol(handle, cast(void**)&wgetstr, "wgetstr");
		...
		dylib_bindSymbol(handle, cast(void**)&winchstr, "winchstr");
		...
		dylib_bindSymbol(handle, cast(void**)&winsertln, "winsertln");
		dylib_bindSymbol(handle, cast(void**)&winsnstr, "winsnstr");
		dylib_bindSymbol(handle, cast(void**)&winsstr, "winsstr");
		dylib_bindSymbol(handle, cast(void**)&winstr, "winstr");
		...
		dylib_bindSymbol(handle, cast(void**)&wstandout, "wstandout");
		dylib_bindSymbol(handle, cast(void**)&wstandend, "wstandend");
		...
		dylib_bindSymbol(handle, cast(void**)&getcurx, "getcurx");
		dylib_bindSymbol(handle, cast(void**)&getcury, "getcury");
		dylib_bindSymbol(handle, cast(void**)&getbegx, "getbegx");
		dylib_bindSymbol(handle, cast(void**)&getbegy, "getbegy");
		dylib_bindSymbol(handle, cast(void**)&getmaxx, "getmaxx");
		dylib_bindSymbol(handle, cast(void**)&getmaxy, "getmaxy");
		dylib_bindSymbol(handle, cast(void**)&getparx, "getparx");
		dylib_bindSymbol(handle, cast(void**)&getpary, "getpary");
		...
		dylib_bindSymbol(handle, cast(void**)&mouse_trafo, "mouse_trafo");
